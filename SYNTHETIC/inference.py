"""
Evaluate trained models on the official SYNTHETIC test set
"""
import os
import sys
import torch
...
from SYNTHETIC.dataset import load_data
from SYNTHETIC.config import BASE_DIR, N_CLASSES, N_ATTRIBUTES
...
def eval(args):
    ...
    loader = load_data([data_dir], args.use_attr, args.no_img, args.batch_size)
    ...
    for data_idx, data in enumerate(loader):
        if args.use_attr:
            if args.no_img:  # A -> Y
                ...
                attr_labels = torch.stack(attr_labels)  # N x 312
    ...
    return class_acc_meter, attr_acc_meter, all_class_labels, topk_class_outputs, all_class_logits, all_attr_labels, all_attr_outputs, all_attr_outputs_sigmoid, wrong_idx, all_attr_outputs2, incorrect_idx_list, all_image_paths, yerr_by_cerr
