from CUB.template_model import CBM_AUC, MLP, inception_v3, End2EndModel
...
# CBM-AUC
def ModelXtoCtoYPlusXtoY(n_class_attr, pretrained, freeze, num_classes, use_aux, n_attributes, expand_dim,
                 use_relu, use_sigmoid):
    return CBM_AUC()
